# `Домашнее задание к занятию «Система мониторинга Zabbix. Часть 2»` - `Михайлов Дмитрий`
...
### Решение 2
 ...
 Результат данного задания сдавайте вместе с заданием 3 - поэтому результаты в "Решении 3".
